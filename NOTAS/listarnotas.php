...
$sql="select n.nocodigo,n.nota1,n.nota2,n.nota3,n.nopromedio,n.nocondicion,m.mturno,a.alunombre,a.alupaterno,a.alumaterno,g.granombre,s.senombre,c.curnombre from matricula as m,grado as g, seccion as s,alumno as a,curso as c,nota as n where c.curcodigo=n.curcodigo and m.nmatricula=n.nmatricula and s.secodigo=g.secodigo and g.gracodigo=m.gracodigo and a.alucodigo=m.alucodigo";
...
<div id="main_content">
  ...
  <tr>
    <td align="center" bgcolor="#FFFF99"><a href="listarnotas.php">- &lt; LISTA NOTAS &gt; -</a></td></tr>
     <tr>
                ...
                <center>
                  ...
                  <table width="628" border="1" bordercolor="#D9DAD5" align="left">
                    <tr>
                       ...
                       <td width="51" bgcolor="#FF9900">Alumno</td>
                      <td width="97" bgcolor="#FF9900">Apellidos</td>
                      <td width="49" bgcolor="#FF9900">Curso</td>
                      <td width="30" bgcolor="#FF9900">Not 1</td>
                      <td width="30" bgcolor="#FF9900">Not 2</td>
                      <td width="30" bgcolor="#FF9900">Not 3</td>
                      <td width="45" bgcolor="#FF9900">Promedio</td>
                      <td width="48" bgcolor="#FF9900">Condicion</td>
                      <td width="51" bgcolor="#FF9900">Grado</td>
                      <td width="20" bgcolor="#FF9900">Sec</td>
                      <td width="32" bgcolor="#FF9900">Turno</td>
...
while ($fila=mysql_fetch_array($rs)){?>
                    ...
                    <td><?php echo $fila['curnombre']  ?></td>
                    <td><?php echo $fila['nota1']  ?></td>
    				<td><?php echo $fila['nota2']  ?></td>
                    <td><?php echo $fila['nota3']  ?></td>
                    <td><?php echo $fila['nopromedio']  ?></td>
                    <td><?php echo $fila['nocondicion']  ?></td>
                    <td><?php echo $fila['granombre']  ?></td>
    				<td><?php echo $fila['senombre']  ?></td>
    				<td><?php echo $fila['mturno']  ?></td>
    				<td align="center" bgcolor="#66FFCC"><a href="modificanota.php?codigonota=<?php echo $fila['nocodigo']  ?>"><img src="images/modificar.gif" border="1" width="32" height="21" /></a><a href="eliminarnota.php?codigonota=<?php echo $fila['nocodigo']  ?>"><img src="images/eliminar.gif" width="32" border="1" height="21" /></a></td>
                    </tr><?php } ?>
                    <tr>
