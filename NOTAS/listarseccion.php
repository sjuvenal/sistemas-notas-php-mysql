...
<div id="main_content">
  ...
  <tr>
    <td align="center" bgcolor="#FFFF99"><a href="listarseccion.php">- &lt; LISTA SECCION &gt; -</a></td>
    </tr>
</table></div>	
                    </div> 
            ...
            <div id="right_section">
                ...
                <div class="right_box">
               		<div class="title">LISTA DE SECCIONES DEL COLEGIO SANTO TOMAS</div>
                ...
                <div class="left_box_borde">
                  <form id="form1" name="form1" method="post" action="grabaseccion.php">
                <center>
                  <table width="449" border="1" bordercolor="#FF0000" align="center">
                    <tr>
                      
                      <td width="54" bgcolor="#FF9900">Nombre</td>
                      <td width="304" bgcolor="#FF9900">Descripcion</td>
...
while ($fila=mysql_fetch_array($rs)){
    ?>
    				...
    				<td align="center" bgcolor="#66FFCC"><a href="modificaseccion.php?codigoseccion=<?php echo $fila[0]  ?>"><img src="images/modificar.gif" border="1" width="32" height="21" /></a><a href="eliminarseccion.php?codigoseccion=<?php echo $fila[0]  ?>"><img src="images/eliminar.gif" width="32" border="1" height="21" /></a></td>
                    </tr><?php } ?>
                    <tr>
                      <td colspan="3"><marquee>Formulario de lista de secciones</marquee></td>
                    </tr>
