...
$sql1="select a.alunombre,a.alupaterno,a.alumaterno,g.granombre,a.aludni from matricula as m 
inner join alumno as a on m.alucodigo=a.alucodigo
inner join grado as g on m.gracodigo=g.gracodigo
where a.aludni='46937287'";
...
<div id="main_content">
  ...
  <tr>
    ...
    <tr>
      ...
      <td colspan="4" bgcolor="#99FF00"><input type="text" value="<?php echo $fila[0]." ".$fila[1]." ".$fila[2]  ?>" size="30" name="codmatricula2" id="codmatricula2" /></td>
    ...
    <tr>
      ...
      <td bgcolor="#99FF00"><input type="text" value="<?php echo $fila['senombre']  ?>" size="3" name="codmatricula4" id="codmatricula4" /></td>
      <td align="center" bgcolor="#99FF00">&nbsp;</td>
    </tr>
    <tr> 
