...
function valida_envia(){
	...
	if (!isNaN(document.fvalida.nombre.value)){
		alert("Tiene que escribir su nombre del GRADO")
		document.fvalida.nombre.focus()
		return false;
	}
	
	if (document.fvalida.seccion.selectedIndex==0){
		alert("Debe seleccionar la SECCION.")
		document.fvalida.seccion.focus()
		return 0;
	}
	if (!isNaN(document.fvalida.descripcion.value)){
		alert("Tiene que escribir la descripcion del GRADO")
		document.fvalida.descripcion.focus()
		return false;
	}
	
	//el formulario se envia
	alert("El Registro del Grado Es Exitoso");
...
<div id="main_content">
  ...
  <tr>
    <td align="center" bgcolor="#FFFF66"><a href="notagrado.php">- &lt; REGISTRAR GRADO &gt; -</a></td>
    </tr>
  <tr>
    <td><a href="listargrado.php">LISTA GRADO</a></td>
            ...
            <div id="right_section">
                ...
                <div class="left_box_borde">
                  <form id="form1" name="fvalida" method="post" action="grabagrado.php">
                <center>
    ...
    ?>
                    ...
                    <tr>
                      <td height="16" align="right" valign="top">NOMBRE DEL AULA</td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td colspan="2" align="right"><input type="reset" name="button" id="button" value="Limpiar" /></td>
                      <td align="center" bgcolor="#FF9900"><input type="button" name="button2" id="button2" value="Registrar Grado" onclick="valida_envia()" /></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
