...
$sql="select * from usuario where uscodigo=$codigousuario";
...
<div id="main_content">
        ...
        <div id="page_content">
            ...
            <div id="right_section">
                ...
                <form id="form1" name="form1" method="post" action="actualizausuario.php">
                <center>
                  <table width="526" border="0">
                    <tr>
                      <td width="112"  height="35" align="right" bgcolor="#FFFF66">Codigo:</td>
                      <td width="167" align="left"><input type="text" name="codigousuario" size="10"value="<?php echo $fila[0]  ?>" id="codigousuario" /></td>
                      <td width="98">&nbsp;</td>
                      <td width="119">&nbsp;</td>
                      <td width="8">&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="2" align="left">
                        ...
                        <input type="text" name="nombre" size="40"value="<?php echo $fila[1]  ?>" id="nombre" />
                      </td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td align="left"><input type="text" name="usuario" value="<?php echo $fila[3]  ?>" id="usuario" /></td>
                      <td align="right">&nbsp;</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="2" align="left"><input type="text"  value="<?php echo $fila[4]  ?>"name="tipo" id="tipo" /></td>
                      <td align="center" bgcolor="#FF9900"><input type="submit" name="button2" id="button2" value="Registrar Usuario" /></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="34" align="right" bgcolor="#FFFF66">Clave</td>
                      <td align="left"><input type="text" value="<?php echo $fila[5]  ?>"name="clave" id="clave" /></td>
                      <td align="right">&nbsp;</td>
                      <td align="center">&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
