...
<div id="main_content">
  ...
  <tr>
    <td align="center" bgcolor="#FFFF99"><a href="listardocente.php">- &lt; LISTA DOCENTE &gt; -</a></td>
    </tr>
</table></div>	
                    </div> 
            ...
            <div id="right_section">
                ...
                <div class="right_box">
               		<div class="title">LISTA DE DOCENTES DEL COLEGIO SANTO TOMAS</div>
                ...
                <center>
                  <table width="619" border="1" bordercolor="#FF0000" align="left">
                    <tr>
                      ...
                      <td width="54" bgcolor="#FF9900">SEXO</td>
                      <td width="71" bgcolor="#FF9900">DNI</td>
                      <td width="127" bgcolor="#FF9900">Direccion</td>
                      <td width="73" bgcolor="#FF9900">Telefono</td>
...
while ($fila=mysql_fetch_array($rs)){
    ?>
    				...
    				<td align="center" bgcolor="#66FFCC"><a href="modificadocente.php?codigodocente=<?php echo $fila[0]  ?>"><img src="images/modificar.gif" border="1" width="32" height="21" /></a><a href="eliminardocente.php?codigodocente=<?php echo $fila[0]  ?>"><img src="images/eliminar.gif" width="32" border="1" height="21" /></a></td>
                    </tr><?php } ?>
                    <tr>
                      <td colspan="7"><marquee>Formulario de lista de docentes</marquee></td>
                    </tr>
