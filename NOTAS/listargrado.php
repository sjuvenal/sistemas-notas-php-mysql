...
<div id="main_content">
  ...
  <tr>
    <td align="center" bgcolor="#FFFF99"><a href="listarcurso.php">- &lt; LISTA GRADO &gt; -</a></td>
    </tr>
</table></div>	
                    </div> 
            ...
            <div id="right_section">
                ...
                <div class="left_box_borde">
                  <form id="form1" name="form1" method="post" action="grabagrado.php">
               
                  <table width="619" border="1" bordercolor="#FF0000" align="left">
                    <tr>
                      
                      <td width="143" height="21" bgcolor="#FF9900">Grado</td>
                      <td width="213" bgcolor="#FF9900">Nombre de AULA</td>
                      <td width="120" bgcolor="#FF9900">Seccion</td>
...
while ($fila=mysql_fetch_array($rs)){
    ?>
    				...
    				<td align="center"><?php echo $fila["granombre"]  ?></td>
   				 	<td align="center"><?php echo $fila["gradescripcion"]  ?></td>
    				<td align="center"><?php echo $fila["senombre"]  ?></td>
    				<td align="center" bgcolor="#66FFCC"><a href="modificagrado.php?codigogrado=<?php echo $fila["gracodigo"]  ?>"><img src="images/modificar.gif" border="1" width="32" height="21" /></a><a href="eliminargrado.php?codigogrado=<?php echo $fila["gracodigo"]  ?>"><img src="images/eliminar.gif" width="32" border="1" height="21" /></a></td>
                    </tr><?php } ?>
                    <tr>
                      <td colspan="4"><marquee>Formulario de lista de alumnos</marquee></td>
                    </tr>
