...
$sql="select c.curcodigo,c.curnombre,c.curdescripcion,d.donombre from curso as c, docente as d where d.docodigo=c.docodigo";
...
<div id="main_content">
  ...
  <tr>
    <td align="center" bgcolor="#FFFF66"><a href="listarcurso.php">- &lt; LISTA CURSO&gt; -</a></td>
    </tr>
</table></div>	
                    </div> 
            ...
            <div id="right_section">
                ...
                <div class="left_box_borde">
                  <form id="form1" name="form1" method="post" action="grabacurso.php">
                <center>
                  <table width="619" border="1" bordercolor="#FF0000" align="left">
                    <tr>
                      
                      <td width="143" height="21" bgcolor="#FF9900">CURSO</td>
                      <td width="213" bgcolor="#FF9900">DESCRIPCION</td>
                      <td width="120" bgcolor="#FF9900">DOCENTE</td>
                      <td width="115" bgcolor="#FF9900">Accion</td>
                    </tr>
                    <?php
while ($fila=mysql_fetch_array($rs)){
    ?>
    				...
    				<td align="center"><?php echo $fila["curnombre"]  ?></td>
   				 	<td align="center"><?php echo $fila["curdescripcion"]  ?></td>
    				<td align="center"><?php echo $fila["donombre"]  ?></td>
    				<td align="center" bgcolor="#66FFCC"><a href="modificacurso.php?codigocurso=<?php echo $fila["curcodigo"]  ?>"><img src="images/modificar.gif" border="1" width="32" height="21" /></a><a href="eliminarcurso.php?codigocurso=<?php echo $fila["curcodigo"]  ?>"><img src="images/eliminar.gif" width="32" border="1" height="21" /></a></td>
                    </tr><?php } ?>
                    <tr>
                      <td colspan="4"><marquee>
                      Formulario de lista de CURSOS
                      </marquee></td>
                    </tr>
